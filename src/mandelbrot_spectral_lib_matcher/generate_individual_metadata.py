...
df_meta = df_meta[['sample_id', 'sample_type', 'SUBSTANCE_NAME', 'kingdom_cof', 'phylum_cof', 'class_cof',
                   'order_cof', 'family_cof', 'genus_cof', 'species_cof', 'corrected', 'broad_organ', 'tissue',
                   'subsystem',
...
df_bio = pd.read_csv("../../Desktop/PF-collection MTS final 22.05.2019_pour_Bioscore.csv", sep=';',
                     usecols=['leish_donovani_10ugml', 'leish_donovani_2ugml', 'tryp_brucei_rhodesiense_10ugml',
                              'tryp_brucei_rhodesiense_2ugml', 'tryp_cruzi_10ugml', 'l6_cytotoxicity_10ugml',
                              'MS_filename'])
...
plate_date_dict = pd.Series(df_for_plate_date.ms_injection_date.values,
                            index=df_for_plate_date.sample_plate_id).to_dict()
...
df_meta_bio.to_csv(
    "//farma-ad2/FARMA-Network/Recherche/COMMON FASIE-FATHO/PF_project/201109_VGF_pos_new_treatment/VGF_individual_files_pos/VGF_clean_metadata_with_bio_with_qc_and_blanks.tsv",
    sep='\t', index=False)
